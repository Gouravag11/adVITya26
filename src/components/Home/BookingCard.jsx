...
export default function BookingCard({ variants }) {
    return (
        <motion.div variants={variants} className='bg-black w-full h-full rounded-3xl p-5 flex flex-col justify-between relative overflow-hidden text-white'>
            ...
            <div className="relative z-10 mt-2">
                ...
                <p className="text-[10px] text-stone-500 leading-relaxed max-w-[90%]">
